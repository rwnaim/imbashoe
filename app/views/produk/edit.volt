<h1 align="center"><a href=""><img src="/public/img/logo.png" style="max-height: 100px; max-width: 100px;"></a> | Tambah
    Produk</h1>

<form autocomplete="off" method="post" action="{{ url('Produk/update/' ~ prod.id_produk) }}">
    <table class="table table-bordered table-hover">
        <tbody class="thead-light">
            ...
            <tr>
                <th colspan="2">
                    <h3 align="center"><?php echo $this->tag->submitButton(["Tambah", 'class' => 'btn btn-primary']); ?>
