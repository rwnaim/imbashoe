...
<div class="row flex-lg-nowrap">
  ...
  <div class="col">
    <form method="POST" action="<?= $this->url->get('produk/update/' . $this->session->get('auth')['id_produk']) ?>" autocomplete="off" class="form-signin">
      <div class="row">
        <div class="col mb-3">
          <div class="card">
            <div class="card-body">
              <div class="e-profile">
                <div class="row">
                  ...
                  <div class="col d-flex flex-column flex-sm-row justify-content-between mb-3">
                    <div class="text-center text-sm-left mb-2 mb-sm-0">
                      <h4 class="pt-sm-2 pb-1 mb-0 text-nowrap"><?= $this->session->get('auth')['nama'] ?></h4>
                      <p class="mb-0"><?= $this->session->get('auth')['username'] ?></p>
                      <div class="mt-2">
                ...
                <div class="tab-content pt-3">
                  <div class="tab-pane active">
                    ...
                    <!-- method="post" action="<?= $this->url->get('signUp/update/' . $user->id_user) ?>" -->
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="col-12 col-md-3 mb-3">
          <div class="card mb-3">
            <div class="card-body">
              <div class="px-xl-3">
                <a type="button" class="btn btn-block btn-secondary" href="<?= $this->url->get('Session/logout') ?>"></a>
