...
<div class="row flex-lg-nowrap">
  ...
  <div class="col">
    <form method="POST" action="<?= $this->url->get('signup/update/' . $this->session->get('auth')['id_user']) ?>" autocomplete="off" class="form-signin">
      <div class="row">
        <div class="col mb-3">
          <div class="card">
            <div class="card-body">
        ...
        <div class="col-12 col-md-3 mb-3">
          <div class="card mb-3">
            <div class="card-body">
              <div class="px-xl-3">
                <a type="button" class="btn btn-block btn-secondary" href="<?= $this->url->get('Session/logout') ?>">
