            ...
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div class="card card-signin my-5">
                    <div class="card-body">
                        ...
                        <form method="POST" autocomplete="off" action="<?= $this->url->get('Produk/update/' . $produk->id_produk) ?>"
                            ...
                            <a href="<?= $this->url->get('/produk/list') ?>" class="btn btn-lg btn-primary btn-block text-uppercase"
